    ...
    return (
        <section className="  flex flex-col md:flex-row items-center justify-between px-16 py-10 min-h-[800px] bg-[#FFFFFF
            ...
            <div className="relative w-[701px] h-[654px] flex items-center justify-center mt-[-300px] left-[40px]">
                <div className="absolute w-[400px] h-[400px] border-[1px] border-[#0A3A45] opacity-20 rounded-full left-10 top-20 z-0"></div>


                <div className="absolute w-[400px] h-[400px] border-[1px] border-[#FFC107] opacity-30 rounded-full right-5 bottom-30 z-0"></div>

                <div className="absolute w-[400px] h-[400px] bg-[#FFC107] opacity-5 rounded-full blur-[100px] z-0"></div>
                <img
                    src={heroImg}
